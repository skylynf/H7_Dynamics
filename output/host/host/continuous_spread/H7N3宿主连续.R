...
setwd("E:/qinliugan/H7/H7N3/beast/continuous/连续地图/host/anser")
setwd("E:/qinliugan/H7/H7N3/beast/continuous/连续地图/host/gall")

setwd("E:/qinliugan/H7/H7N3/beast/continuous/连续地图/host/domestic")
library(seraphim)
...
allTrees = scan(file="H7N3anser.trees", what="", sep="\n", quiet=T)

burnIn = 0
randomSampling = FALSE
nberOfTreesToSample = 100
mostRecentSamplingDatum = 2022.64
coordinateAttributeName = "location"

allTrees = scan(file="H7N3gall.trees", what="", sep="\n", quiet=T)
burnIn = 0
randomSampling = FALSE
nberOfTreesToSample = 100
...
allTrees = scan(file="H7N3domestic.trees", what="", sep="\n", quiet=T)
burnIn = 0
randomSampling = FALSE
nberOfTreesToSample = 100
mostRecentSamplingDatum = 2024.39
...
mcc_tre = readAnnotatedNexus("H7N3anserMCC.tree")
mcc_tre = readAnnotatedNexus("H7N3gallMCC.tree")
mcc_tre = readAnnotatedNexus("H7N3domesticMCC.tree")
