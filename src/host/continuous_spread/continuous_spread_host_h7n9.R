...
mcc_tre = readAnnotatedNexus("H7N9anserMCC.tree")
...
allTrees = scan(file="H7N9gall.trees", what="", sep="\n", quiet=T)
burnIn = 0
randomSampling = FALSE
nberOfTreesToSample = 100
...
source("mccExtractions2.r")
mcc_tre = readAnnotatedNexus("H7N9gallMCC.tree")
mcc_tab = mccExtractions(mcc_tre, mostRecentSamplingDatum)
write.csv(mcc_tab, "YFV_MCC.csv", row.names=F, quote=F)
...
localTreesDirectory = "Tree_extractions"
allTrees = scan(file="H7N9wild.trees", what="", sep="\n", quiet=T)
burnIn = 0
randomSampling = FALSE
nberOfTreesToSample = 100
mostRecentSamplingDatum = 2021.02
...
source("mccExtractions2.r")
mcc_tre = readAnnotatedNexus("H7N9wildMCC.tree")
mcc_tab = mccExtractions(mcc_tre, mostRecentSamplingDatum)
write.csv(mcc_tab, "YFV_MCC.csv", row.names=F, quote=F)
...
localTreesDirectory = "Tree_extractions"
allTrees = scan(file="H7N9domestic.trees", what="", sep="\n", quiet=T)
burnIn = 0
randomSampling = FALSE
nberOfTreesToSample = 100
...
source("mccExtractions2.r")
mcc_tre = readAnnotatedNexus("H7N9domesticMCC.tree")
mcc_tab = mccExtractions(mcc_tre, mostRecentSamplingDatum)
write.csv(mcc_tab, "YFV_MCC.csv", row.names=F, quote=F)
