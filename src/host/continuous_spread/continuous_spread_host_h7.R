...
allTrees = scan(file="H7_anser.trees", what="", sep="\n", quiet=TRUE)
burnIn = 0
...
mcc_tre = readAnnotatedNexus("H7_anserMCC.tree")
...
allTrees = scan(file="H7_gall.trees", what="", sep="\n", quiet=T)
burnIn = 0
randomSampling = FALSE
nberOfTreesToSample = 100
mostRecentSamplingDatum = 2024.49
coordinateAttributeName = "location"
...
source("mccExtractions2.r")
mcc_tre = readAnnotatedNexus("H7_gallNCC.tree")
mcc_tab = mccExtractions(mcc_tre, mostRecentSamplingDatum)
write.csv(mcc_tab, "YFV_MCC.csv", row.names=F, quote=F)
...
localTreesDirectory = "Tree_extractions"
allTrees = scan(file="wild.trees", what="", sep="\n", quiet=T)
burnIn = 0
randomSampling = FALSE
nberOfTreesToSample = 100
mostRecentSamplingDatum = 2023.91
coordinateAttributeName = "location"
...
source("mccExtractions2.r")
mcc_tre = readAnnotatedNexus("wildMCC.tree")
mcc_tab = mccExtractions(mcc_tre, mostRecentSamplingDatum)
write.csv(mcc_tab, "YFV_MCC.csv", row.names=F, quote=F)
...
localTreesDirectory = "Tree_extractions"
allTrees = scan(file="domestic.trees", what="", sep="\n", quiet=T)
burnIn = 0
randomSampling = FALSE
nberOfTreesToSample = 100
mostRecentSamplingDatum = 2024.49
...
source("mccExtractions2.r")
mcc_tre = readAnnotatedNexus("domesticMCC.tree")
mcc_tab = mccExtractions(mcc_tre, mostRecentSamplingDatum)
write.csv(mcc_tab, "YFV_MCC.csv", row.names=F, quote=F)
